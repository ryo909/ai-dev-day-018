import './style.css';
const PROFILE = {"day":"Day018","title":"Daily Routine Slotter","one_sentence":"習慣タスクを時間枠で回しやすくするルーティンプランナー。（話題:HN Frontpage）","core_action":"schedule","family":"routine_slots","mechanic":"slot_assignment_with_streak","input_style":"task_cards","output_style":"checklist_timeline","audience_promise":"higher_habit_streak","publish_hook":"連続達成を見ながら習慣を回す","engine":"slot_planner","interaction_archetype":"checklist_slot_planner","page_archetype":"timeline_planner","output_shape":"slot_checklist","state_model":"slots_with_completion_flags","core_loop":"assign -> complete -> streak","component_pack":"slot_grid+streak_badges","scaffold_id":"slot_checklist_planner","single_shot_text_generator":false};
